            ...
            <div class="row g-4">
                ...
                <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.6s">
                    <div class="service-item">
                        ...
                        <div class="rounded-bottom p-4">
                            <a href="{{ route('disease.form') }}" class="h4 d-inline-block mb-4">Disease Detection</a>
                            <p class="mb-4">Click below to open disease detection form.</p>

                            <a href="{{ route('disease.form') }}" class="btn btn-primary rounded-pill py-2 px-4">Upload Here</a>
                        </div>
                    </div>
                </div>
