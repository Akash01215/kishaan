<div class="container-fluid testimonial pb-5">
    <div class="container pb-5">
        <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.2s" style="max-width: 800px;">
            ...
            <h1 class="display-5 mb-4">What Farmers Say About Krishi AI</h1>
            <p class="mb-0">Discover what our users have to say about how Krishi AI has transformed their farming practices with intelligent crop, fertilizer, and disease management support.</p>
        </div>
        <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.2s">
            <div class="testimonial-item">
                ...
                <div class="testimonial-title">
                    <div>
                        <h4 class="mb-0">Ramesh Thapa</h4>
                        <p class="mb-0">Farmer, Chitwan</p>
                    </div>
            ...
            <div class="testimonial-item">
                ...
                <div class="testimonial-title">
                    <div>
                        <h4 class="mb-0">Sunita Karki</h4>
                        <p class="mb-0">Farmer, Dang</p>
                    </div>
                    <div class="d-flex text-primary">
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
