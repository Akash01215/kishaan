            ...
            <div class="col-md-6 col-lg-6 col-xl-4">
                <div class="footer-item">
                    <a href="index.html" class="p-0">
                        <h4 class="text-white"><i class="fas fa-seedling me-3"></i>Krishi AI</h4>
                    </a>
                    <p class="mb-4">Krishi AI is an intelligent farming assistant platform that supports farmers by recommending crops, fertilizers, and detecting plant diseases through voice and image inputs.</p>
                    <div class="d-flex">
